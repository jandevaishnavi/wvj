...
<div class="header">
		<div class="logo">
<div id="color">			<h1><a href="index.php"><img src="Images/l.png" width ="10000px" height="200px" alt=""></a></h1>
</div>		</div>
	</div>
</div>
</div>
...
<div class="main_cont">
     <div class="main">
        <div class="content">
          <img src="Images/a1.png" width="550px" height="550px" style="margin:auto" />
            <br/><br/>
...
<tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:50px; padding-top:10px; padding-bottom:10px; color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center"> 
   <a href="Admin/pic/blood_donation_camp.jpg<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/blood_donation_camp.jpg<?php echo $data[5] ?>" height="400px" width="400px" style="margin:auto; padding-left:20px" /></a></td></tr>
    ...
    <tr><td>&nbsp;</td></tr>
          ...
          <tr><td class="title"  style="vertical-align:middle">Organised By:<?php echo $data[2]; ?></td><td align="left" width="50px"></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<div class="f_nav">
		...
		<ul>			<li class="active"><a href="index.php">Home</a></li>			
			...
			<li><a href="admin/admimlogin.php">Admin</a></li>	</ul>
</div>
</div>	
</div>
</div>
	<div class="copy">	<p class="title">© All Rights Reserved </p>  </div>
