...
<div style="height:730px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background:linear-gradient(to right,rgba(255,0,0,0),rgba(255,0,0,1)); border:2px solid pink; box-shadow:4px 1px 20px pink;">
     <form method="post" enctype="multipart/form-data">
 <table cellpadding="0" cellspacing="0" width="500px" height="480px" style="margin:auto" >

   <tr><td colspan="2" align="center"><img src="Images/rq.png" height="90px" /></td></tr>

   <tr><td>&nbsp;</td><td>&nbsp;</td></tr>   

                   

<tr><td class="lefttd" align="center"> Name:</td><td><input type="text" name="t1" size="30" width="100%" required="required" pattern="[a-zA-Z _]{5,15}" title="please enter only character  between 5 to 15 for donor name" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
$s="select * from bloodgroup";
	...
	{
		if(isset($_POST["show"])&& $data[0]==$_POST["s"])
		{
...
<tr><td class="lefttd" align="center">Detail</td><td><textarea name="t7"></textarea></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td><td><input type="submit" value="Submit" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:40px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:16px; text-shadow:1px 1px 6px black; "></td></tr></table>
