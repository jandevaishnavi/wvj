...
<div style=" height:auto">
  ...
  <table cellpadding="0" cellspacing="0" width="1000px" height="800px" style="margin:auto; border:0px" class="tableborder">
...
?>
  <tr><td  >
            ...
            <table cellpadding="0" cellspacing="0" width="700px" height="100px" style="margin:auto; border:none;" class="tableborder">


                <tr><td width="150px"  align="center" style="vertical-align:middle">

 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:70px; float:left" /></a></td>


                    <td width="300px" height="50px" style="vertical-align:top">
                        

                        <table cellpadding="2" width="500px" height="50px" style="border:none">
...
<div class="footer">
	<div class="f_nav">
		<ul>
			...
			<p class="title">© All Rights Reserved | Design by Vaishnavi Jande |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
