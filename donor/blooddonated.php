...
<div class="wrap">
<div class="header">
		<div class="logo"><div id="grad1"> </div>
...
<div style="height:800px; width:800px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#ffccff; border:2px solid red; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >

        <tr><td colspan="2" align="center"><img src="Images/bdonated.png" height="100px" /></td></tr>
             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<input type="text" name="year" style=" width:100px"  /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
