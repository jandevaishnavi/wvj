...
<div class="h_btm">
	<div class="header-para">
		<table cellpadding="0" cellspacing="0" width="700px">
            <tr><td><img src="Images/donor1.png" height="700px" /></td></tr>
             <tr><td>&nbsp;</td></tr>
            <tr><td style="float:left; text-align:justify">

             <div id="bgg">   <p>Donating blood is a simple thing to do, but it can make a big difference in the lives of others. The donation process from the time you arrive until the time you leave takes about 30 minutes. The donation itself is only about 8-10 minutes on average.
The steps in the process are :</p><br /> </div>
...
<br />Enjoy the feeling of knowing that you helped save precious lives!</p>
            ...
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                     ...
                     <td style="float:right; padding-bottom:900px; padding-left:90px">  <img src="Images/nor1.png" width="15000px" height="500px"  /><br /><br /></br></br><br /><br /><img src="Images/topright.png" width="15000px" height="500px" /></a></td></tr></table></div></div></div>
                      		<br /><br />				
