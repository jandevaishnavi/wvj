...
<div style="height:300px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#ffccff; border:2px solid red; box-shadow:4px 1px 20px black;">
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Vaishnavi |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
