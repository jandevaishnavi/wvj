...
<div class="header">
		<div class="logo">
		<div id="color">
						<h1><a href="index.php"><img src="Images/l.png" width ="10990px" height="200px" alt=""></a></h1>
</div>
		</div>
	</div>
</div>
...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#ffff00; border:2px solid red; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >

    <tr><td colspan="2"  align="center"><img src="Images/donor.png" width="300px" height="90px"  /></td></tr>
   
<tr><td colspan="2">&nbsp;</td></tr>
   
                <tr><td  style=" padding-left:20px;" ><img src="Images/d1.png" width="190px" height="400px" class="shaddoww"/>&nbsp; </td>
