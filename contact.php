...
<div id="grad1">	
    ...
    <div>
<div style="widht:50px; height:800px;  background:linear-gradient(to right,rgba(255,0,0,0),rgba(255,0,0,1));
margin:auto; margin-top:10px; margin-bottom:10px; background-color:#ffff00; border:2px solid red; box-shadow:4px 1px 20px black;">
  ...
  <div   class="col span_2_of_3"> <div class="contact-form" style="padding-left:100px;">
				  	<img src="Images/contactus.jpg" align="center" />
  
    <table  cellspacing="0" cellpadding="0"  width="110px" height="100px">               
