...
<div style="height:600px; width:900px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#ffccff; border:2px solid red; box-shadow:4px 1px 20px black;">
<form method="post">
     <table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >
        ...
        <tr><td colspan="2" align="center"><img src="Images/chpass2.png" height="80px" /></td></tr>
                ...
                <tr><td><img src="Images/chpass.png" width="300px" height="250px" align="right"/></td>
...
<div class="footer">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Miss. Vaishnavi Jande |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
